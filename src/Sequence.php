...
class Sequence implements ArrayAccess, IteratorAggregate
{
    ...
    public function codon($index)
    {
        return substr($this->data, $index, 3);
    }

    public function forCodon($offset)
    {
        $index = 0;
        $size = $this->length() - 3;
    ...
    public function translate($offset = 0, $table = null)
    {
        $table = $table ?? [
    ...
    public function translates($table = null)
    {
        $r = ['n' => [], 'r' => []];
        $seq = clone $this;
...
//Needleman-Wunsch algorithm
    ...
    public static function similarity($seq1, $seq2, $gap_weight = -1.0)
    {
        $seq1 = Sequence::Obj($seq1);
        $seq2 = Sequence::Obj($seq2);
    ...
    public static function align_similarity($seq1, $seq2)
    {
        $alignment = self::align($seq1, $seq2);
        return self::similarity(...$alignment);
    }

    public static function is_reversed($seq1, $seq2)
    {
